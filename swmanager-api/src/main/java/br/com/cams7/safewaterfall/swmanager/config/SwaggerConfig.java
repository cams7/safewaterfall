 ...
 * 
 */
package br.com.cams7.safewaterfall.swmanager.config;
...
import br.com.cams7.safewaterfall.swmanager.endpoint.SirenEndpoint;
...
public class SwaggerConfig {
  ...
  static {
    ENDPOINT_PACKAGE = basePackage(SirenEndpoint.class.getPackage().getName());
  }
  ...
  private static ApiInfo metaData() {
    return new ApiInfoBuilder().title("Safe Waterfall Manager").description("Safe Waterfall Manager").version(
